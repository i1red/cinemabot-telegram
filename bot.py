...
answerPopular = {'en': 'Only the most popular films will be shown', 'uk' : 'Тільки айпопулярніші фільми будуть відображені', 'zh' : '只會播放最受歡迎的電影'}
...
async def updateMessage(update, context):
    ...
    if not search.results:
        answer = {'en': 'No result. Please, change your query', 'uk' : 'Нічого не знайдено. Будь ласка, змініть запит', 'zh' : '沒有結果。 請更改您的查詢'}
